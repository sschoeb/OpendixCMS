...
class OpenIcJuniorResult extends OpenModulBase
{
	public function Overview()
	{
		return;
		$link = 'http://comp.swisstennis.ch//jic2010/servlet/EntryPage?Lang=D&ClubName=1097&btnOK=';
	...
	public function Item()
	{
		...
		$link = 'http://comp.swisstennis.ch//jic2010/servlet/TeamResults?TeamId=' . $nr . '&Lang=D';
