...
Ajax.Request.prototype = Object.extend(new Ajax.Base(), {
  ...
  request: function(url) {
    ...
    try {
      	...
      	//Dieser Teil musste hinzugefügt werden, damit der IE nicht alles Cached
      	this.transport.setRequestHeader("Pragma", "no-cache");
	  	this.transport.setRequestHeader("Cache-Control", "must-revalidate");
		this.transport.setRequestHeader("If-Modified-Since", document.lastModified);
